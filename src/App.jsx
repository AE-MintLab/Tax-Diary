  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-slate-50 to-teal-50 font-sans flex flex-col">
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto p-4 space-y-4 pb-24">
        ...
        {/* Hero Banner */}
        <div className="bg-white/90 backdrop-blur-md rounded-3xl p-5 sm:p-6 shadow-xl border-2 border-emerald-200/70 relative overflow-hidden space-y-4">
          <div className="absolute -top-10 -right-10 w-32 h-32 bg-emerald-200/50 rounded-full blur-2xl pointer-events-none" />
          <div className="absolute -bottom-10 -left-10 w-32 h-32 bg-teal-200/50 rounded-full blur-2xl pointer-events-none" />
          ...
          <div className="grid grid-cols-2 gap-3 relative">
            ...
            <div className="bg-gradient-to-br from-teal-50 to-teal-50 border border-teal-200 p-3 rounded-2xl">
              <p className="text-[10px] font-black uppercase tracking-wider text-teal-600">Total Reliefs Claimed</p>
              <p className="text-lg sm:text-2xl font-black mt-0.5 text-teal-600">RM {totalReliefs.toLocaleString()}</p>
              <p className="text-[10px] font-medium opacity-70 text-teal-600">Chargeable income: RM {chargeable.toLocaleString()}</p>
            </div>
          </div>
        </div>
